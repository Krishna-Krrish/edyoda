...
let confirmPasswordError = document.getElementById("confirmPassowrd-error");
    ...
    if (!email.value.match(pattern)) {
      ...
      if (password.value.length < 3) {
        ...
        if (password.value == confirmPassword.value) {
          ...
          confirmPasswordError.innerText = "Password Matched";
          confirmPasswordError.style.visibility = "visible";
          confirmPasswordError.style.color = "blue";
          console.log("'line22'");
        } else {
          console.log("Password does not match");
          confirmPasswordError.innerText = "Passwordd does not Matched";
